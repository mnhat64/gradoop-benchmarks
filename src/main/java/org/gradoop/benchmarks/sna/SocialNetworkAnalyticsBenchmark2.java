...
import org.gradoop.benchmarks.sna.functions.CountFilter;
 ...
 */
public class SocialNetworkAnalyticsBenchmark2 extends AbstractRunner {
  /**
  ...
  public static void main(String[] args) throws Exception {
    CommandLine cmd = parseArguments(args, SocialNetworkAnalyticsBenchmark2.class.getName());

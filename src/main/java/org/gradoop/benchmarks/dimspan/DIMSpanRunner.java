 ...
 */
public class DIMSpanRunner extends AbstractRunner {
   ...
   */
  private static final String OPTION_MIN_SUPPORT = "ms";
  /**
   * Option to enable undirected mining mode
   */
  private static final String OPTION_UNDIRECTED_MODE = "u";
